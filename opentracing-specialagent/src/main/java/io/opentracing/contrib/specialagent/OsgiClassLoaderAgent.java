...
//                         //     ClassLoaderLogger.log(injectedOn, "ContextClassLoader found " + e);
// 						// } catch (ClassNotFoundException ignored) {
...
// 			}
		...
		public static void onExit(
			...
			// } else {
                // TODO: Should probably check bootstrap as well, and can limit scope to io.opentracing
                // Should also limit the other one to io.opentracing packages, for optimization
