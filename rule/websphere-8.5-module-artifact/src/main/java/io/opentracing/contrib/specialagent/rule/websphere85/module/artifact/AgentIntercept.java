...
public class AgentIntercept {
	private static final Logger logger = Logger.getLogger(AgentIntercept.class.getName());
	...
	public static Object exit(final Object thiz, final Object returned, final Object resObj, final Object filter, final Object artifactClassLoader) {
		...
		ClassLoaderLogger.log((ClassLoader) thiz, "Exit getResource for " + resName);
		ClassLoaderLogger.dumpHierarchy((ClassLoader) thiz);
		ClassLoaderLogger.log((ClassLoader) thiz, "Found " + returned);
